  ...
  <div class="w-192 mx-auto">
    ...
    <div class="mt-8">
      ...
      <form action="{{ route('contact') }}" method="post">
        @csrf
        <div class="mb-4">
          <label for="name" class="block text-left p-1 my-1 font-medium">
            お名前
        ...
        <div class="mb-4">
          <label for=name_kana class="block text-left p-1 my-1 font-medium">お名前（フリガナ）
            <span class="text-white text-xs bg-yellow-400 mx-2 py-1 px-2">必須</span>
            @error('name_kana')
              <span class="text-red-400">{{ $message }}</span>
            @enderror
        ...
        <div class="mb-4">
          <label for="email" class="block text-left p-1 my-1 font-medium">メールアドレス<span class="text-white text-xs bg-yellow-400 mx-2 py-1 px-2">必須</span>
            @error('email')
              <span class="text-red-400">{{ $message }}</span>
            @enderror
          </label>
        ...
        <div class="mb-4">
          <label for="body" class="block text-left p-1 my-1 font-medium">お問い合わせ内容<span class="text-white text-xs bg-yellow-400 mx-2 py-1 px-2">必須</span>
            @error('body')
              <span class="text-red-400">{{ $message }}</span>
            @enderror
          </label>
